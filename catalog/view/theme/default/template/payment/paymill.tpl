    ...
    <form id='paymill_form' action="<?php echo $paymill_form_action; ?>" method="POST">
        ...
        <div class="debit paymill_relative">
            ...
            <div class='paymill_icons'>
                <?php if($paymill_icon_visa){ echo "<img src=\"$paymill_image_folder/32x20_visa.png\">"; }?>
                <?php if($paymill_icon_master){ echo "<img src=\"$paymill_image_folder/32x20_mastercard.png\">"; }?>
                <?php if($paymill_icon_amex){ echo "<img src=\"$paymill_image_folder/32x20_amex.png\">"; }?>
                <?php if($paymill_icon_jcb){ echo "<img src=\"$paymill_image_folder/32x20_jcb.png\">"; }?>
                <?php if($paymill_icon_maestro){ echo "<img src=\"$paymill_image_folder/32x20_maestro.png\">"; }?>
                <?php if($paymill_icon_diners_club){ echo "<img src=\"$paymill_image_folder/32x20_dinersclub.png\">"; }?>
                <?php if($paymill_icon_discover){ echo "<img src=\"$paymill_image_folder/32x20_discover.png\">"; }?>
                <?php if($paymill_icon_china_unionpay){ echo "<img src=\"$paymill_image_folder/32x20_unionpay.png\">"; }?>
                <?php if($paymill_icon_dankort){ echo "<img src=\"$paymill_image_folder/32x20_dankort.png\">"; }?>
                <?php if($paymill_icon_carta_si){ echo "<img src=\"$paymill_image_folder/32x20_carta-si.png\">"; }?>
                <?php if($paymill_icon_carte_bleue){ echo "<img src=\"$paymill_image_folder/32x20_carte-bleue.png\">"; }?>
            </div>
